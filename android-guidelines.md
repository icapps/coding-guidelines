# iCapps Android Code Style Guidelines

This style guide outlines the coding conventions of the Android teams at iCapps. We used the one of Google because we feel it's the most complete. Differences may be seen when we update it to our needs.
 ...
 * [RxJava Chains Styling](#rxjava-chains-styling)
...
* [Javatests Style Rules](#javatests-style-rules)
